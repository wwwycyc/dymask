...
class RefactorSupportC5H3Editor(RefactorSupportC5H2Editor):
    def __init__(
        self,
        pipe,
        config,
        ...
        **kwargs,
        ...
        self.underedit_support_gain = validate_unit_interval(underedit_support_gain, "underedit_support_gain")
        self.underedit_mask_gain = validate_unit_interval(underedit_mask_gain, "underedit_mask_gain")
        self.underedit_anchor_gain = validate_unit_interval(underedit_anchor_gain, "underedit_anchor_gain")
    ...
    def _extra_step_aux_tensors(
        ...
        if self._latest_underedit_context is not None:
            tensors.update(self._latest_underedit_context)
        ...
        if "underedit_anchor_relax_mask" in components:
            tensors["underedit_anchor_relax_mask"] = components["underedit_anchor_relax_mask"]
        if "underedit_anchor_rescued_mask" in components:
            tensors["underedit_anchor_rescued_mask"] = components["underedit_anchor_rescued_mask"]
        if "confidence_anchor_relax_mask_base" in components:
            tensors["confidence_anchor_relax_mask_base"] = components["confidence_anchor_relax_mask_base"]
        return tensors

class RefactorSupportC5H4Editor(RefactorSupportC5H3Editor):
    def __init__(
        self,
        pipe,
        config,
        ...
        **kwargs,
        ...
        super().__init__(pipe, config, **kwargs)
        self.underedit_temporal_rho = validate_unit_interval(
