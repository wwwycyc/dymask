...
class V1SourcePromptSourceAnchoredSupportC3OnlyEditor(V1SourcePromptSourceAnchoredSupportEditor):
    def __init__(
        self,
        pipe,
        config,
        ...
        payload.update(
            {
                ...
                "roi_mask_policy": "baseline adaptive anchoring with delayed soft-aware support memory so early support stays hard and soft roi enters only after editing has formed",
