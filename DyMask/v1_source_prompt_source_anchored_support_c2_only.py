...
class V1SourcePromptSourceAnchoredSupportC2OnlyEditor(V1SourcePromptSourceAnchoredSupportEditor):
    def __init__(
        self,
        pipe,
        config,
        ...
        payload.update(
            {
                ...
                "background_anchor_policy": "baseline adaptive anchoring with an additional early-delay gate so source anchoring ramps in only after editing has formed",
