...
from .v1_source_prompt_validated_support_factorized import V1SourcePromptValidatedSupportFactorizedEditor

import torch


class V1SourcePromptSourceAnchoredValidatedSupportFactorizedEditor(
    V1SourcePromptValidatedSupportFactorizedEditor
):
        ...
        payload.update(
            {
                ...
                "roi_mask_policy": "factorized validated discrepancy accumulation with outside-roi source anchoring",
