...
from .v1_source_prompt_source_anchored_support_c3 import V1SourcePromptSourceAnchoredSupportC3Editor


class V1SourcePromptSourceAnchoredSupportC4Editor(V1SourcePromptSourceAnchoredSupportC3Editor):
    def __init__(
        self,
        pipe,
        config,
    ...
    def _support_floor_mask(
        ...
        return (strength * support_memory_roi).clamp(0.0, 1.0)
