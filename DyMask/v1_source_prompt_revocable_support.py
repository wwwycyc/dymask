...
class V1SourcePromptRevocableSupportEditor(V1SourcePromptHardRoiLockedEditor):
    def __init__(
        self,
        pipe,
        config,
    ...
    def _reference_prompt_metadata(self, sample: MaterializedSample) -> dict[str, object]:
        ...
        payload.update(
            {
                "variant": "source_prompt_revocable_support_v1",
                "roi_mask_policy": "always hard roi times dynamic evidence with revocable temporal support accumulation",
