...
from DyMask.v1_source_prompt_source_anchored_graph_refined_attention import (
    V1SourcePromptSourceAnchoredGraphRefinedAttentionEditor,
)
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--attention-graph-beta", type=float, default=0.40)
    ...
    save_json(
        ...
        {
            "variant_name": "source_prompt_source_anchored_graph_refined_attention_v1",
            ...
            "mechanism": "Hard ROI bounded temporal support with graph-refined A_t and outside-roi source latent anchoring",
            ...
            "attention_refinement": "A^(k+1) = (1-beta) * A_raw + beta * W_self * A^(k)",
    ...
    logger.log(
        stage="source_prompt_source_anchored_graph_refined_attention",
        ...
        conclusion="samples and source-anchored graph-refined config saved",
    ...
    editor = V1SourcePromptSourceAnchoredGraphRefinedAttentionEditor(
        pipe,
        config,
    ...
    logger.log(
        ...
        conclusion="source-anchored graph-refined prompt run finished",
        next_step="inspect summary tables and visual editing strength",
    )
