...
def main(argv: list[str] | None = None) -> None:
    ...
    save_json(
        ...
        {
            "variant_name": "source_prompt_source_anchored_hard_roi_proedit_like_v1",
            "ddim_inversion_prompt_mode": "source_prompt",
            "reference_branch_prompt_mode": "source_prompt",
            "attention_prompt_mode": "target_prompt",
            "mechanism": "Hard ROI editing with outside-roi source anchoring and ProEdit-inspired localized latent/feature mixing",
    ...
    logger.log(
        ...
        conclusion="samples and ProEdit-inspired config saved",
