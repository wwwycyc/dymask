...
from .operator_routing_v9 import (
    OperatorRoutingV9Config,
    apply_operator_routing_v9_eps,
    build_operator_routing_v9_state,
)
...
class V1SourcePromptSourceAnchoredOperatorRoutingV9Editor(V1SourcePromptSourceAnchoredHardRoiEditor):
    def __init__(
        self,
        pipe,
        config,
        ...
        self.routing_config = OperatorRoutingV9Config(core_rewrite_max_gain=float(core_rewrite_max_gain))
        ...
        payload.update(
            {
                ...
                "core_rewrite_formula": "G_t = gamma * interiority * T_t",
                "boundary_stabilization_formula": "B_t = boundaryness * (T_t * S_t) / (T_t + S_t)",
                "execution_formula": "eps = (1-roi) * eps_src + roi * [eps_tar + G_t * (eps_tar - eps_src) + B_t * (eps_stabilize - eps_tar - G_t * (eps_tar - eps_src))]",
                ...
                "core_rewrite_max_gain": self.routing_config.core_rewrite_max_gain,
            }
        )
        return payload
    ...
    def _compose_effective_mask_from_aux(
        ...
        routing_state = build_operator_routing_v9_state(
