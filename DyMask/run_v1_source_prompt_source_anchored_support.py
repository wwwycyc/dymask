...
from DyMask.v1_source_prompt_source_anchored_support import V1SourcePromptSourceAnchoredSupportEditor
...
def main(argv: list[str] | None = None) -> None:
    ...
    run_prefix = (
        f"{config.phase}_source_prompt_source_anchored_support"
    ...
    logger.log(
        stage="source_prompt_source_anchored_support",
        ...
        conclusion="samples and source-anchored support config saved",
    ...
    editor = V1SourcePromptSourceAnchoredSupportEditor(
        pipe,
        config,
    ...
    logger.log(
        ...
        conclusion="source-anchored temporal-support prompt run finished",
        next_step="inspect summary tables and visual background preservation",
    )
